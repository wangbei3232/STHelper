...
namespace Common
{
    public abstract class SqlHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        public static readonly string connStr = ConfigurationManager.ConnectionStrings["SqlConnectionString"].ConnectionString;
        ...
        /// <remarks>
        /// e.g.:  
        ///  int result = ExecuteNonQuery(Framework.ConnString, CommandType.StoredProcedure, "PublishOrders");
        /// </remarks>
        ...
        /// <remarks>
        /// e.g.:  
        ///  int result = ExecuteNonQuery(Framework.ConnString, CommandType.StoredProcedure, "PublishOrders", new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a SqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataset(Framework.ConnString, CommandType.StoredProcedure, "GetOrders");
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a SqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataset(Framework.ConnString, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a SqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  SqlDataReader dr = ExecuteReader(Framework.ConnString, CommandType.StoredProcedure, "GetOrders");
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a SqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  SqlDataReader dr = ExecuteReader(Framework.ConnString, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a SqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  int orderCount = (int)ExecuteScalar(Framework.ConnString, CommandType.StoredProcedure, "GetOrderCount");
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a SqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  int orderCount = (int)ExecuteScalar(Framework.ConnString, CommandType.StoredProcedure, "GetOrderCount", new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a SqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        public static DataTable ExecuteDataTable(string connectionString, string commandText)
        {
            using (SqlConnection aConnection = new SqlConnection(connectionString)) {
                ...
                SqlCommand aCommand = new SqlCommand(commandText, aConnection);
                aConnection.Open();
        ...
        public static DataView ExecuteDataView(string connectionString, string commandText)
        {
            using (SqlConnection aConnection = new SqlConnection(connectionString)) {
        ...
        public static string ExecuteScalar(string connectionString, string commandText, params SqlParameter[] commandParameters)
        {
            using (SqlConnection aConnection = new SqlConnection(connectionString)) {
        ...
        public static SqlParameter MakeInParam2(string ParamName, SqlDbType DbType, Int32 Size, object Value)
        {
            SqlParameter param;
